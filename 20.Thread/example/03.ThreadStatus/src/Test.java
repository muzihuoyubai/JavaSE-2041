...
//     club.banyuan.thread.status.Test.sleep(1500);
//
//     // 线程2代码执行到此处时，线程1的代码执行到了 thread2.join();（74行）
//     System.out.println("线程1中调用了线程2的join()方法，thread1的状态 -" +
//         club.banyuan.thread.status.Test.thread1.getState());
//     club.banyuan.thread.status.Test.sleep(200);
//   }
// }
//
...
//     thread1 = new Thread(new club.banyuan.thread.status.Test());
//
...
//
//   public void run() {
//     Thread thread2 = new Thread(new club.banyuan.thread.status.OtherThread());
//
//     // 线程2已经创建，并且当前处于NEW
...
//         thread2.getState());
//
//     Thread thread3 = new Thread(new club.banyuan.thread.status.BlockTestThread());
//     Thread thread4 = new Thread(new club.banyuan.thread.status.BlockTestThread());
//     thread3.start();
//     sleep(200);
//     thread4.start();
...
//     synchronized (club.banyuan.thread.status.Test.lock) {
//       club.banyuan.thread.status.Test.sleep(1000);
//     }
//   }
// }